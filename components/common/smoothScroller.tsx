...
/**
 * A component that wraps the content with smooth scrolling functionality using GSAP library.
 * It creates a smooth scrolling experience when navigating the page.
 * @param children - The content to be wrapped with smooth scrolling.
 * @returns A component that wraps the content with smooth scrolling functionality.
 */
