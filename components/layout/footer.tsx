...
export default function Footer() {
  ...
  return (
    <footer
      ref={el}
      className="bg-black pb-6 pt-16 text-crftd-white before:pointer-events-none before:absolute before:-bottom-2 before:h-4 before:w-full before:bg-black md:pb-12 md:pt-24 xl:pt-32"
    >
